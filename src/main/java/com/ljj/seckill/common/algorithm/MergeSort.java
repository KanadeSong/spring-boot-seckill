...
public class MergeSort {
     ...
     * @return void
     * @Description: 归并排序算法
     * @Param [list 待排序的列表, tempList 临时列表, head 列表开始位置, rear 列表结束位置]
     * @author LeeJack
     * @Date 15:36 2019/4/30/030
     */
    ...
    /**
     * @return void
     * @Description: 合并操作(列表的两两合并)
     * @Param [list , tempList, head, middle, rear]
     * @author LeeJack
     * @Date 17:20 2019/4/30/030
     */
